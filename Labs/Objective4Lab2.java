...
// output sum of intigers.
    sumOfInt = num1 + num2 + num3;
    System.out.println("The sum of " + num1 + " + " + num2 + " + " + num3 + " = " + sumOfInt );

// output sum of doubles
    sumOfDub = dub1 + dub2 + dub3;
    System.out.println("The sum of " + dub1 + " + " + dub2 + " + " + dub3 + " = " + sumOfDub );
  }
}
